...
public class SharedElementTransitionManualDetailActivity extends AppCompatActivity {
    ...
    public static Intent createIntent(Context context, View view, Uri sharedElementUri) {
        Intent intent = new Intent(context, SharedElementTransitionManualDetailActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shared_element_transition_manual_detail);
    ...
    private void initAnimation() {
        ...
        mAnimationView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                ...
                int targetWidth = WindowUtil.getWidth(SharedElementTransitionManualDetailActivity.this);
                int targetHeight = targetWidth * width / height;
                int toolBarHeight = getResources().getDimensionPixelSize(R.dimen.toolbar_height);
                int statusBarHeight = WindowUtil.getStatusBarHeight(SharedElementTransitionManualDetailActivity.this);
